...
<body>
 ...
 <%@ include file="../base/header.jsp" %>
                ...
                <table class="tabMenu">
					...
					<td>
						<p>
							...
							<td>
								<p>
									<a href="board_info?bc_no=3" style="border: none;">정보게시판</a>
								</p>
							</td>
	...
	<ul class="page-num">
		...
		<a href="board_farm?page=1&category=${map.nDto.category}&searchword=${map.nDto.searchword}">
		<li class="first"></li></a>
		...
		<c:if test="${map.nDto.page>1}">
			<a
				href="board_farm?page=${map.nDto.page-1}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><img
		...
		<c:forEach var="nowpage" begin="${map.nDto.startpage}"
			...
			<li class="num"><c:if test="${map.nDto.page!=nowpage}">
					<a
						href="board_farm?page=${nowpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><div>${nowpage}</div></a>
		...
		<a
			href="board_farm?page=${map.nDto.maxpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"></a>
	</ul>
