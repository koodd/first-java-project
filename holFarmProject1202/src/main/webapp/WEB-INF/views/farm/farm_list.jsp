                ...
                <nav class="detail-condition-nav">
                        ...
                        <li class="course">
                            ...
                            <div class="area">
                                <ul class="course-list" >
                                    ...
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="경기"><span>경기도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="인천"><span>인천</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="충북"><span>충청북도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="충남"><span>충청남도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="강원"><span>강원도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="전북"><span>전라북도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="전남"><span>전라남도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="경북"><span>경상북도</span></label></li>
                                    <li><label class="box-radio-input"><input type="radio" name="region" value="경남"><span>경상남도</span></label></li>
                    ...
                    <c:if test="${session_ucno==2 }">
	                    <div style="margin-top: 20px; height: 200px;">
	                        <a href="./farm_regi"><img src="../images/main3.jpg" alt="내 농장 등록하기" style="height: 100%;"></a>
	                    </div>
                    </c:if>
                </nav>
            </div>
                            ...
                            <div class="shop-main-area">
                                <div class="shop-main">
                                    ...
                                    <div class="shop-main-bottom">
                                        <div class="price">
                                            <div class="sale ">
                                                <p class="sale-price">${farmDto.fr_price}원</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
