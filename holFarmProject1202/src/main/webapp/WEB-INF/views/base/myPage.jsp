                ...
                <ul class="list-unstyled navbar__list">
                    <li class="has-sub">
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                <a href="../member/my_info_updet?u_no=${session_uno}">회원정보 수정</a>
                            </li>
                            <li>
                                <a href="#">회원탈퇴</a>
                            </li>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            ...
                            <li>
                                <a href="../member/my_exp_myBook">체험 예약 내역</a>
                            </li>
                        </ul>
                    </li>
                    </c:if>
                    ...
                    <li>
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            ...
                            <li>
                                <a href="../member/my_exp_regmodify?u_no=${session_uno}&e_no=${session_eno}">체험 정보 수정</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                <a href="../member/my_farm_Reser_Now">농장 예약 현황</a>
                            </li>
                            <li>
                                <a href="../member/my_exp_book">체험 예약 현황</a>
                            </li>
                        </ul>
                    </li>
                    </c:if>
