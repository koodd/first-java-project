        ...
        <div class="contentTitle">
            ...
            <div class="content_view_top">
                ...
                <span
                        ...
                        style="padding-left: 20px; ">신고수 : </span><span>${map.bDto.boardDto.bt_report}</span></div>
            </div>
            <div>
		  ...
		  <div class="coment_view_comm_view" >
            ...
            <div class="board_btn">
                <button type="button" class="content_btn managerbuttoncss" onclick="location.href='man_board_report_list?bc_no=${map.bDto.boardDto.bc_no}'">목록</button>
                
                <form action="./man_board_report_delete" id="delete_board_man" method="post">
