...
<body>
    ...
    <form action="./man_public_modify" name="modify" id="modify" method="post" enctype="multipart/form-data">
        ...
        <div class="container">
            <div class="col-lg-3">
                ...
                <div id="titlearea">
                    <label>제목</label>
                    <input type="text" name="bn_title" value="${map.bDto.bn_title}">
                </div>
                <div id="uploadarea">
              		    
                    <label>파일명</label>
                     <label>${map.bDto.bn_upload }</label>
