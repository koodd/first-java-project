    ...
    <section id="contentArea">
        ...
        <div class="contentTitle">
		  ...
		  <div class="coment_view_comm_view" >
            ...
            <div class="board_btn">
                <button type="button" class="content_btn managerbuttoncss" onclick="location.href='my_board_list'">목록</button>
                
                <form action="./my_board_View_delete" id="delete_board_man" method="post">
