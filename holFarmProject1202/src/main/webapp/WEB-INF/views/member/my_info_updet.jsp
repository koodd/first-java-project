...
<head>
    ...
    // 가져온 은행 value 값 넣기
 	...
 	// 체크박스가 체크된 상태에서 라디오버튼 아니오 눌렀을때 체크 박스 해제하기
 	
/* 	 			var radioChk = $('input:radio[name=receive]').is(':checked');		// true
	 			alert(radioChk);
 				if(radioChk==false){
 					alert("같지않음");
 					$("input:checkbox[id='u_infoway1']").prop("checked", false);
 					$("input:checkbox[id='u_infoway2']").prop("checked", false);
 				}else{
 					alert("같음");
 				} */
	            ...
	            <tbody>
	                ...
	                <tr>
	                    ...
	                    <td>
	                        <ul class="question">
	                            <li>
	                                <input type="checkbox" name="u_infoway" id="u_infoway1" value="문자" />문자
	                            </li>
	                            <li>
	                                <input type="checkbox" name="u_infoway" id="u_infoway2" value="이메일" />이메일
	                            </li>
	                        </ul>
	                    </td>
	                </tr>
