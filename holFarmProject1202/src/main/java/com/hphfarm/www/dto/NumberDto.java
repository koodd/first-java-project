...
public class NumberDto {
	...
	/*
	 * // 상품 관련 넘버링 생성자 public NumberDto(int page, int limit, int numlimit, int
	 * listcount, int maxpage, int startpage, int endpage, int startrow, int endrow,
	 * String category, String searchword, int pc_no) { super(); this.page = page;
	...
	public NumberDto(int page, int limit, int numlimit, int listcount, int maxpage, int startpage, int endpage,
			int startrow, int endrow, String category, String searchword, int bc_no) {
		super();
		this.page = page;
		this.limit = limit;
		this.numlimit = numlimit;
