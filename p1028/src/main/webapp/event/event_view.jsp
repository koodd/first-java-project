	...
	$.ajax({
		...
		success:function(data){
			...
			for(var i=0;i<data.commentList.length;i++){
				chtml += "<ul id='"+data.commentList[i].cno+"'>";
				chtml += "<li class='name'>"+data.commentList[i].id+"<span>&nbsp;[ "+data.commentList[i].cdate +" ]</span></li>";
...
<script type="text/javascript">
   $(function(){
					...
					<div class="replyWrite">
						<ul>
							<li class="in">
								<p class="txt">총 <span id="allCount" class="orange">3</span> 개의 댓글이 달려있습니다.</p>
								<p class="password">비밀번호&nbsp;&nbsp;<input type="password" class="replynum" name="cpw" /></p>
