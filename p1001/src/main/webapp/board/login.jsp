...
<head>
  ...
  <script type="text/javascript">
    ...
    function loginCheck(){
    	...
    	console.log("id값 : "+$("#txtId").val());
        //alert("id값 : "+$("#txtId").val().length);
...
<body>
  ...
  <section>
    ...
    <form action="./doLogin.jsp" name="login" id="loginForm" method="post">
      <div class="id">
        <input type="text" name="id" id="txtId" size="30" placeholder="CJ ONE 통합아이디 6~20자">
      </div>
      <div class="pw">
        <input type="text" name="pw" id="txtPw" size="45" placeholder="비밀번호 영문, 특수문자, 숫자혼합 8~12자">
      </div>
