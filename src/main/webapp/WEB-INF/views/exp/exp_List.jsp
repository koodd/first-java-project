...
<body style="margin: 0 auto; width: 1200px;">
    ...
    <div class="wrapper">
        ...
        <c:if test="${session_ucno==2}">
    	    <div>
        	    <a href="./exp_Reg?u_no=${session_uno}" class="exp_reg" id="expBtn">체험 프로그램 등록하기</a>
	        </div>
        </c:if>
  ...
  <!--        체험 프로그램 리스트 가져오기 -->
        ...
        <div class="exp_ListPost">
            ...
            <a href="./exp_View?e_no=${expDto.e_no}&page=${map.nDto.page}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><h3 class="e_name">${expDto.e_name}</h3></a><br>
            <a  href="./exp_View?e_no=${expDto.e_no}&page=${map.nDto.page}&category=${map.nDto.category}&searchword=${map.nDto.searchword}">
            	<img src="../upload/${expDto.e_thumb}" alt="농장체험테스트사진" style="width: 1200px; height: 600px">
            </a><br>
