		...
		<div id="content_view">
					...
					<c:if test="${map.bDto.bn_upload != null }">
						<tr>
							<td colspan="4" class="article"><img
								src="../upload/${map.bDto.bn_upload}"
								style="max-height: 1000px; max-width: 600px; margin: 0 auto;">
							</td>
						</tr>
					</c:if>
					<p  style="white-space:pre;">${map.bDto.bn_content}</p>
			...
			<div id="content_view_bottom2">
				...
				<div id="content_view_next">
					<a
						href="./board_public_view?bn_no=${map.preDto.bn_no}&page=${nDto.page}&category=${nDto.category}&searchword=${nDto.searchword}">${map.preDto.bn_title}</a>
				</div>
			</div>
			...
			<div id="content_view_bottom1">
				...
				<div id="content_view_prev">
					<a
						href="./board_public_view?bn_no=${map.nextDto.bn_no}&page=${nDto.page}&category=${nDto.category}&searchword=${nDto.searchword}">${map.nextDto.bn_title}</a>
				</div>
			</div>
			<div class="board_btn">
				<button type="submit" class="content_btn"
					onclick="location.href='board_public?page=${nDto.page}&category=${nDto.category}&searchword=${nDto.searchword}'">목록</button>
			</div>
