...
<body>
	...
	<section>
		<div class="mainimg">
			...
			<div class="p_message">
				<span><a href="../main" style="color: blue;">>HOME</a>>커뮤니티>게시글작성</span>
			</div>
		</div>
	</section>
	...
	<section id="wholewrite">
		<form action="./board_wirte_do" name="write" id="write" method="post"
			...
			<div class="container">
				<div class="col-lg-3">
					<div class="writearea_md">
						...
						<div id="uploadarea">
							<label>파일명</label> <input type="file" id="file" name="file">
						</div>
						<div class="contentarea">
							<label>내용</label>
							<textarea placeholder="내용을 입력하세요" name="bt_content"
								id="bt_content"></textarea>
						</div>
						<div id="write_logo">
