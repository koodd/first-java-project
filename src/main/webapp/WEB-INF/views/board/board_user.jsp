	...
	<section>
		<div id="boardmargin">
			...
			<ul class="page-num">
				...
				<a href="board_user?bc_no=2&page=1&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><li
					class="first"></li></a>
				...
				<c:if test="${map.nDto.page>1}">
					<a
						href="board_user?bc_no=2&page=${map.nDto.page-1}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><img
				...
				<c:forEach var="nowpage" begin="${map.nDto.startpage}"
					...
					<li class="num"><c:if test="${map.nDto.page!=nowpage}">
							<a
								href="board_user?bc_no=2&page=${nowpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><div>${nowpage}</div></a>
				...
				<a
					href="board_user?bc_no=2&page=${map.nDto.maxpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"></a>
			</ul>
					...
					<div class="s_search">
						<div class="s_down">
							<div id="search_box_type">
								...
								<input type="hidden" name="bc_no" value="2"> <select
