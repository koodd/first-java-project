...
<body>
	...
	<section>
		<div class="mainimg">
			...
			<div class="p_message">
				<span><a href="../main" style="color: blue;">HOME</a>>커뮤니티>유저거래</span>
			</div>
		</div>
	</section>
	...
	<ul class="page-num">
		...
		<a
			href="board_trade?bc_no=4&page=1&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><li
			class="first"></li></a>
		...
		<c:if test="${map.nDto.page>1}">
			<a
				href="board_trade?bc_no=4&page=${map.nDto.page-1}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><img
		...
		<c:forEach var="nowpage" begin="${map.nDto.startpage}"
			...
			<li class="num"><c:if test="${map.nDto.page!=nowpage}">
					<a
						href="board_trade?bc_no=4&page=${nowpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><div>${nowpage}</div></a>
		...
		<a
			href="board_trade?bc_no=4&page=${map.nDto.maxpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"></a>
	</ul>
	...
	<form action="./board_trade" name="search" method="get">
		<div class="nav">
			<div class="s_search">
				<div class="s_down">
					<div id="search_box_type">
						<input type="hidden" name="bc_no" value="4"> <select
