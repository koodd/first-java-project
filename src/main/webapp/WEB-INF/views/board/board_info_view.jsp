		...
		<div id="content_view">
			...
			<div id="content_view_bottom2">
				...
				<div id="content_view_next">
					<a
						href="./board_info_view?bn_no=${map.preDto.bn_no}&page=${nDto.page}&category=${nDto.category}&searchword=${nDto.searchword}">${map.preDto.bn_title}</a>
				</div>
			</div>
			...
			<div id="content_view_bottom1">
				...
				<div id="content_view_prev">
					<a
						href="./board_info_view?bn_no=${map.nextDto.bn_no}&page=${nDto.page}&category=${nDto.category}&searchword=${nDto.searchword}">${map.nextDto.bn_title}</a>
				</div>
			</div>
			<div class="board_btn">
				<button type="submit" class="content_btn"
					onclick="location.href='board_info?page=${nDto.page}&category=${nDto.category}&searchword=${nDto.searchword}'">목록</button>
			</div>
