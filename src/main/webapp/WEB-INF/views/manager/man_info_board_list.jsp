...
<body>
	<section id="contentArea">
		...
		<div id="boardArea">
				...
				<c:forEach items="${map.list}" var="bDto">
					...
					<div class="b_tr">
						...
						<div class="b_td b_title">
							<a
								href="./man_info_board_view?bn_no=${bDto.bn_no}&page=${map.nDto.page}&category=${map.nDto.category}&searchword=${map.nDto.searchword}">${bDto.bn_title}</a>
						</div>
			...
			<div class="manage_btn">
				<button type="button" onclick="location.href='man_info_board_write'">글작성</button>
			</div>
	...
	<ul class="page-num">
		...
		<a href="man_info_board_list?page=1&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><li
			class="first"></li></a>
		...
		<c:if test="${map.nDto.page>1}">
			<a
				href="man_info_board_list?page=${map.nDto.page-1}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><img
		...
		<c:forEach var="nowpage" begin="${map.nDto.startpage}"
			...
			<li class="num"><c:if test="${map.nDto.page!=nowpage}">
					<a
						href="man_info_board_list?page=${nowpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"><div>${nowpage}</div></a>
		...
		<a
			href="man_info_board_list?page=${map.nDto.maxpage}&category=${map.nDto.category}&searchword=${map.nDto.searchword}"></a>
	</ul>
	...
	<form action="./man_info_board_list" name="search" method="get">
		<div class="nav">
			<div class="s_search">
				<div class="s_down">
