	...
	<div class="site-wrap">
		...
		<div class="site-section" id="section1">
			<div class="container">
				...
				<div id="title2">
					<form action="do_my_pur_write3" method="post"
						enctype="multipart/form-data">
						<div id="py_no1box">
							<input class="reg1" type="hidden" id="hidden" name="py_no"
								value="${py_no}"><br>
						</div>
						<div id="creason1box">
							<label><span id="font1">사유:</span></label>
							<textarea class="reg1" id="c_reason" name="c_reason"></textarea>
							<br>
						</div>
						<div id="cpic1box">
							<label><span id="font1">사유사진: </span></label> <input class="reg1" type="file" id="file" name="file"><br>
						</div>
						<div id="cbtn1box">

							<button type="submit" id="btn1">등록</button>
							<button type="button" id="btn2"
								onclick="location.href='./my_pur_list'">취소</button>
