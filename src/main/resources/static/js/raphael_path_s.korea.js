	...
	for (var state in aus) {
		...
		(function (st, state) {
			...
			st[0].onclick = function () {
				...
				switch(state) {
					case "seoul":
						location.href="../farm/farm_list?region=서울";
						current = state;
						break;
					case "gygg":
						location.href="../farm/farm_list?region=경기";
						current = state;
						break;
					case "incheon":
						location.href="../farm/farm_list?region=인천";
						current = state;
						break;
					case "gangwon":
						location.href="../farm/farm_list?region=강원";
						current = state;
						break;
					case "chungbuk":
						location.href="../farm/farm_list?region=충북";
						current = state;
						break;
					case "chungnam":
						location.href="../farm/farm_list?region=충남";
						current = state;
						break;
					case "daejeon":
						location.href="../farm/farm_list?region=대전";
						current = state;
						break;
					case "sejong":
						location.href="../farm/farm_list?region=세종";
						current = state;
						break;
					case "jeonbuk":
						location.href="../farm/farm_list?region=전북";
						current = state;
						break;
					case "gwangju":
						location.href="../farm/farm_list?region=광주";
						current = state;
						break;
					case "jeonnam":
						location.href="../farm/farm_list?region=전남";
						current = state;
						break;
					case "gyeongbuk":
						location.href="../farm/farm_list?region=경북";
						current = state;
						break;
					case "daegu":
						location.href="../farm/farm_list?region=대구";
						current = state;
						break;
					case "gyeongnam":
						location.href="../farm/farm_list?region=경남";
						current = state;
						break;
					case "ulsan":
						location.href="../farm/farm_list?region=울산";
						current = state;
						break;
					case "busan":
						location.href="../farm/farm_list?region=부산";
						current = state;
						break;
					case "jeju":
						location.href="../farm/farm_list?region=제주";
						current = state;
						break;
